...
export default function CurrentMonth() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Container maxWidth="xxl" className={classes.content}>CurrentMonthCurrentMonthCurrentMonthCurrentMonthCurrentMonthCurrentMonthCurrentMonthCurrentMonthCurrentMonth
