...
export default function LastQuarter() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Container maxWidth="xxl" className={classes.content}> Last Quarter Last Quarter Last Quarter Last Quarter Last Quarter Last Quarter Last Quarter Last Quarter Last Quarter
